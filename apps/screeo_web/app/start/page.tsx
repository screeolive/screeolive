...
import { Google } from "@/components/icons/GoogleColor";
        ...
        <div className="min-h-screen bg-[#08090a] text-white flex flex-col justify-center items-center p-4">
            ...
            <div className="w-full max-w-md bg-white/5 backdrop-blur-lg border border-white/10 p-8 rounded-2xl shadow-xl">
                ...
                <button
                    ...
                    className="mt-6 cursor-pointer w-full flex items-center justify-center gap-3 bg-white text-black font-semibold rounded-xl py-3 hover:bg-gray-200 transition-all"
                >
                    <Google />
